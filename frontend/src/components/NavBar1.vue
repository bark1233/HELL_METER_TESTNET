<template>
  <div class="main-nav-div">
    <b-navbar class="main-nav" toggleable="sm" type="dark" variant="dark">
      ...
      <hell-balance-display class="ml-auto d-none d-sm-flex" />
      ...
      <div class="d-flex d-sm-none">
        <hell-balance-display class="hell-display-mobile" />
...
import HellBalanceDisplay from './smart/HellBalanceDisplay.vue';
...
.dropdown-menu {
  ...
  background: linear-gradient(45deg, #250000 0%, rgba(36,39,32,1) 100%);
...
@media (max-width: 576px) {
  ...
  .hell-display-mobile > .balance-container {
    font-size: 0.8em;
  }
