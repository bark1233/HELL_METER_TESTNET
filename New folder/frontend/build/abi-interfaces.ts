...
export interface HellStakingRewards {
  acceptOwnership(): Web3JsAbiCall<void>;
  balanceOf(account: string): Web3JsAbiCall<string>;
...
export interface HellStakingRewardsUpgradeable {
  balanceOf(account: string): Web3JsAbiCall<string>;
  earned(account: string): Web3JsAbiCall<string>;
  enableFailsafeMode(): Web3JsAbiCall<void>;
  exit(): Web3JsAbiCall<void>;
...
export interface NFTMarket {
  ...
  grantRole(role: string, account: string): Web3JsAbiCall<void>;
  hasRole(role: string, account: string): Web3JsAbiCall<boolean>;
  hellToken(): Web3JsAbiCall<string>;
  ...
  initialize(_hellToken: string, _taxRecipient: string): Web3JsAbiCall<void>;
  ...
  recoverHell(amount: string | number): Web3JsAbiCall<void>;
...
export interface WTHell {
  ...
  oneFrac(): Web3JsAbiCall<string>;
  priceOracleHellPerUsd(): Web3JsAbiCall<string>;
  promos(): Web3JsAbiCall<string>;
  ...
  initialize(_hellToken: string, _characters: string, _weapons: string, _priceOracleHellPerUsd: string, _randoms: string): Web3JsAbiCall<void>;
  migrateTo_1ee400a(): Web3JsAbiCall<void>;
  migrateTo_aa9da90(): Web3JsAbiCall<void>;
  migrateTo_ef994e2(_promos: string): Web3JsAbiCall<void>;
  ...
  recoverHell(amount: string | number): Web3JsAbiCall<void>;
  getHellToSubtract(_inGameOnlyFunds: string | number, _tokenRewards: string | number, _hellNeeded: string | number): Web3JsAbiCall<[string, string, string]>;
  getHellNeededFromUserWallet(playerAddress: string, hellNeeded: string | number): Web3JsAbiCall<string>;
  ...
  giveInGameOnlyFunds(to: string, hellAmount: string | number): Web3JsAbiCall<void>;
  giveInGameOnlyFundsFromContractBalance(to: string, hellAmount: string | number): Web3JsAbiCall<void>;
  usdToHell(usdAmount: string | number): Web3JsAbiCall<string>;
  ...
  getTotalHellOwnedBy(wallet: string): Web3JsAbiCall<string>;
