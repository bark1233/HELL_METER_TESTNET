    ...
    AccessControlUpgradeable
{
    ...
    // Initializer
    // ############
    function initialize(IERC20 _hellToken, address _taxRecipient)
        public
        initializer
    {
    ...
    //IPriceOracle public priceOracleHellPerUsd; // we may want this for dynamic pricing
    ...
    function purchaseListing(
        ...
        hellToken.transferFrom(msg.sender, taxRecipient, taxAmount);
        hellToken.transferFrom(
            msg.sender,
            listing.seller,
    ...
    function recoverHell(uint256 amount) public restricted {
        hellToken.transfer(msg.sender, amount); // dont expect we'll hold tokens here but might as well
    }
