...
module.exports = {
  ...
  networks: {
    ...
    bsctestnet: {
      provider: () => new HDWalletProvider(
        process.env.BINANCE_WALLET_MNEMONIC, 'wss://wstest.meter.io'
      ),
      network_id: 83,
      gas: 20000000,
      gasPrice: 9500000000,
    ...
    avaxtestnet: {
      provider: () => new HDWalletProvider(hdWalletProviderOptions(
        process.env.MTR_TESTNET_WALLET_PRIVATE_KEY,
        process.env.MTR_TESTNET_WALLET_MNEMONIC,
        {
          providerOrUrl: process.env.MTR_TESTNET_RPC_URL || 'https://api.avax-test.network/ext/bc/C/rpc'
        }
      )),
  ...
  api_keys: {
    bscscan: '1SJ9C2DGV2QJT7Z7362D2Z187BYTYKXNQG',
    snowtrace: '1SJ9C2DGV2QJT7Z7362D2Z187BYTYKXNQG'
  },
  // subscribers: {
